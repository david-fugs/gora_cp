        ...
        <div class="modal-body">
            ...
            <table class="table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    //SI LA HORA VIENE EN NUMERO ENTERO O FLOAT PASAMOS A HORA Y MINUTOS
                    $htreb = $dto->decimalsToTimeFormat($htreb);
                    $hnit = $dto->decimalsToTimeFormat($hnit);
                    $hpaus = $dto->decimalsToTimeFormat($hpaus);

                    echo
                    '<tr>
                        <td><input type="time" name="hora1" value="'.$hini.'"></td>
                        <td><input type="time" name="hora2" value="'.$hfi.'"></td>
                        <td><input type="text" name="htreb" min="0" max="24" size="3" value="'.$htreb.'"></td>
                        <td><input type="text" name="hnoct" min="0" max="24" step="0.1" size="3" value="'.$hnit.'"></td>
                        <td><input type="text" name="hdesc" min="0" max="24" step="0.1" size="3" value="'.$hpaus.'"></td>
