    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-3">
            <div style="text-align: center"> <h2 class=""><?php echo $dto->mostraNomEmpPerId($id);?>  </h2><br>
                <label class=""><?php echo $dto->__($lng,"Hores")." ".$dto->__($lng,"Teòriques")." ".$dto->__($lng,"año")." ".$any;?>:</label> <strong> <?php echo $dto->seleccionaHoresTeoriques($id, $any); ?> </strong><br>
        ...
        <center>
            ...
            <div>
                <table class="table table-striped table-hover table-condensed" style="text-align: center">
                    ...
                    <tbody>
                    <?php
                    $horari = $dto->seleccionaHorarisEmpPerId($id, $any);
        ...
        <div class="modal-dialog glassmorphism">
            <div class="modal-content glassmorphism">
                <div class="modal-body">
                    ...
                    <h4><?php echo $dto->__($lng,"Esta seguro de eliminar el periodo especial de: ");?> <span id="tipusexcepaelim"></span></h4>
                    <br><br>
