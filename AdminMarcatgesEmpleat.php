...
<div class="row" style="margin-top: 40px">
    <div class = "col-lg-3"  style ="text-align: left; margin-left: 50px;">
        ...
        <span class="smbox">
			...
			echo '
            <button class="btn-next-m btn-sm" onclick="mostraInformeMesAuto(' . $id . ',' . $any . ',' . $mes . ",'" . $setmana . "'" . ');" title="' . $dto->__($lng, "Informe") . " 2 " . $dto->__($lng, "Marcatges") . '"><span class="glyphicon glyphicon-list-alt"></span> 2M</button>';
            ...
            echo '
            <button class="btn-next btn-sm" onclick="mostraInformeMesMT(' . $id . ',' . $any . ',' . $mes . ",'" . $setmana . "'" . ');" title="' . $dto->__($lng, "Informe") . " 4 " . $dto->__($lng, "Marcatges") . '"><span class="glyphicon glyphicon-list-alt"></span> 4M</button>';

            echo '
            <button class="btn-next btn-sm" onclick="mostraInformeMes6M(' . $id . ',' . $any . ',' . $mes . ",'" . $setmana . "'" . ');" title="' . $dto->__($lng, "Informe") . " 6 " . $dto->__($lng, "Marcatges") . '"><span class="glyphicon glyphicon-list-alt"></span> 6M</button>';

            echo '
            <button class="btn-next btn-sm" onclick="mostraInformeMes8M(' . $id . ',' . $any . ',' . $mes . ",'" . $setmana . "'" . ');" title="' . $dto->__($lng, "Informe") . " 8 " . $dto->__($lng, "Marcatges") . '"><span class="glyphicon glyphicon-list-alt"></span> 8M</button>';
