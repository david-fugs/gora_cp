...
<head>
    ...
    <style>
        ...
        .filtro-text {
            ...
            color: #333;
            margin-right: 10px;
            /* Agrega un espacio entre la palabra "Filtro" y el desplegable */
            color: black;
        ...
        .btn_modal:hover {
            background-color: rgba(81, 209, 246, 0.3);
            /* Cambia el color de fondo durante el hover */
            color: white;
            /* Cambia el color del texto durante el hover */
        }
...
<body class="well">
    ...
    <div id="content">
        ...
        if (isset($_GET["nomhorari"])) {
            ...
            for ($i = 1; $i <= 7; $i++) {
                if (($_GET[$i . "f1"] == 0) || ($_GET[$i . "f2"] == 0) || ($_GET[$i . "f3"] == 0)) {
                } else {
                    if (!isset($_GET[$i . "f5"])) {
                        $_GET[$i . "f5"] = 0;
                    } else {
                    ...
                    <div class="tab-content" style="height: 100%; overflow-y: auto; overflow-x: hidden">
                        <div id="empresa" class="tab-pane fade in active">
                            <div class="row">
                                <div class="col-lg-4">
                                    <br><br>
                                    <h3 class=""><?php echo $dto->__($lng, "Dades"); ?> </h3><br><br><br>
                                    <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <br><br>
                                    <h3 class=""><?php echo $dto->__($lng, "Subempreses") . ' <button class="btn-green btn-medium" onclick="mostraNovaSubemp(' . $idempresa . ');" title="' . $dto->__($lng, "Nova Subempresa") . '"><span class="glyphicon glyphicon-plus"></span></button>'; ?></h3><br><br>
                                    <?php echo $tblsbe; ?>
                                    <br><br>
                                </div>
                                <div class="col-lg-4">
                                    <br><br>
                                    <h3 class="" title="<?php echo $dto->__($lng, "Veure, editar i Crear Departaments"); ?>"><?php echo $dto->__($lng, "Departaments"); ?> <a class="btn-green btn-medium" data-toggle="modal" data-target="#modCreaNouDpt" title="<?php echo $dto->__($lng, "Crea Nou"); ?>"><span class="glyphicon glyphicon-plus"></span></a></h3><br><br>
                                    <table class="">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content glassmorphism">
                                                    <div class="glassmorphism"><button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h3 style="color:white"><?php echo $dto->__($lng, "Crear Departament"); ?></h3>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="GET" action="AdminEmpresa.php">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2"><label><?php echo $dto->__($lng, "Nom"); ?>: </label></div>
                                                                <div class="col-lg-6"><input type="text" id="nomdpt" name="nomdpt" placeholder="<?php echo $dto->__($lng, "Nom del Departament"); ?>" style="width: 100%"></div>
                                                            </div><br>
                                                            <div class="row">
                                                                <div class="col-lg-2"></div>
                                                                <div class="col-lg-2"><label><?php echo $dto->__($lng, "Àmbit"); ?>: </label></div>
                                                                <div class="col-lg-6"><input type="text" id="ambit" name="ambit" placeholder="<?php echo $dto->__($lng, "Nom de l'àmbit"); ?>" style="width: 100%"></div>
                                                            </div><br>
                                                            <br>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-success" data-toggle="modal" onclick="crearDepartamento(<?php echo $idempresa; ?>,)"><span class="glyphicon glyphicon-plus"></span> <?php echo $dto->__($lng, "Crear"); ?></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <table class="table table-striped table-hover table-condensed">
                                        <thead>
                                            ...
                                            <th style="text-align: center; background-color: #FAFAFA; color: black;"><?php echo $dto->__($lng, "Documento"); ?></th>
                                        ...
                                        <tbody style="background-color: white">
                                            ...
                                            foreach ($tipusexcep as $t) {
                                                ...
                                                $isRequere = "<td style='text-align: center;'><input id='isRequere" . $t["idtipusexcep"] . "' type='checkbox' style='height: 20px; width: 20px' onclick='changeRequerePeriodSpecial(this, " . $t["idtipusexcep"] . ");' ";
                                                if ($t["requereixFitxer"] == 1) $isRequere = $isRequere . " checked";
                                                $TableRow .= $isRequere . "></td>";
    ...
    <a href="#" data-toggle="modal" data-target="#modalEliminar' . $t["idtipusexcep"] . '"  class="btn-red btn-small" ><span class="glyphicon glyphicon-remove"></span></a></td>';
                                                ...
                                                echo '<input type="checkbox" name="documento" ' . ($t["requereixFitxer"] ? 'checked' : '') . '><br>';
                                                    ...
                                                    <div class="modal-content glassmorphism">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="crear_periodo.php" method="POST">
                                                                ...
                                                                <label for="documento">Documento necesario: </label>
                                                                <input type="checkbox" name="documento"><br>
                                ...
                                <div class="col-lg-2">
                                    <h3 class="" title="<?php echo $dto->__($lng, "Veure, editar i Crear Tipus de Períodes Especials"); ?>"><?php echo $dto->__($lng, "Marcajes desplegable"); ?>
                                        <button class="btn-green btn-medium" data-toggle="modal" data-target="#modalCrearMarcajeEspecial" title="<?php echo $dto->__($lng, "Crear Nuevo"); ?>"><span class="glyphicon glyphicon-plus"></span></button>
                                    </h3>
                                    <br><br>
                        ...
                        <div id="sistema" class="tab-pane fade in">
                            <div class="row">
                                <div class="col-lg-4">
                                    <br><br>
                                    <h3 class=""><?php echo $dto->__($lng, "Festius"); ?></h3><br><br>
                                    <div class="row">
                                        <div class="col-lg-7">
                                    ...
                                    <br><br>
                                    <h3 class="" title="<?php echo $dto->__($lng, "Veure, editar i Crear Ubicacions i Festius per ubicació"); ?>"><?php echo $dto->__($lng, "Ubicacions"); ?> <a class="btn-green btn-medium" data-toggle="modal" data-target="#modCreaNovaUbicacio" title="<?php echo $dto->__($lng, "Crea Nova"); ?>"><span class="glyphicon glyphicon-plus"></span></a></h3><br><br>
                                        ...
                                        <tbody id="tbodyubicacions">
                                            ...
                                            foreach ($ubicacions as $ubicat) {
                                                ...
                                                echo '<tr style="font-weight: bold"><td title="Activa"><input id="chklocact' . $ubicat["idlocalitzacio"] . '" type="checkbox" ' . $chkact . ' onclick="marcaLocAct(' . $ubicat["idlocalitzacio"] . ');" style="width: 20px; height: 20px"></td><td><input contenteditable data-old_value="' . $ubicat["nom"] . '" value="' . $ubicat["nom"] . '" title="' . $dto->__($lng, "Clica per a editar nom") . '"'
                                                    ...
                                                    . '<a class="btn-green btn-small" title="' . $dto->__($lng, "Afegeix Festiu") . '" onclick="afegeixFestiu(' . $ubicat["idlocalitzacio"] . ',' . "'" . $dto->mostraNomUbicacio($ubicat["idlocalitzacio"]) . "'" . ');">'
                                                    ...
                                                    . '<button type="button" class="btn-blue btn-small" title="' . "Eliminar" . '" onclick="eliminarFestivo(' . $ubicat["idlocalitzacio"] . ')">'
                                    ...
                                    <div class="modal fade" id="modCreaNovaUbicacio" role="dialog">
                                        <center>
                                            <div class="modal-dialog">
                                                <div class="modal-content glassmorphism">
                                                    <div class="glassmorphism"><button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h3 style="color:white;"><?php echo $dto->__($lng, "Crear Nova Ubicació"); ?></h3>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <form name="novaubic" method="GET" action="AdminEmpresa.php" onsubmit="event.preventDefault();">
                                                            <div class="row">
                                                                <div class="col-lg-2"></div>
                                                                <div class="col-lg-2"><label><?php echo $dto->__($lng, "Nom"); ?>: </label></div>
                                                                <div class="col-lg-6"><input type="text" name="nomubicacio" placeholder="<?php echo $dto->__($lng, "Nom de la ubicació"); ?>" style="width: 100%"></div>
                                                            </div><br><br>
                                    ...
                                    <div class="modal fade" id="modAfegeixFestiu" role="dialog">
                                        <center>
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content glassmorphism">
                                                    <div class="glassmorphism"><button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h3 style="color:white;"><?php echo $dto->__($lng, "Afegir Festiu a"); ?>: </h3>
                                                        <h4 style="color:white;" id="calendari"></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <br>
                                    ...
                                    <div class="modal fade" id="modCreaNouRol" role="dialog">
                                        <center>
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content glassmorphism">
                                                    <div class="glassmorphism"><button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h3 style="color:white;"><?php echo $dto->__($lng, "Crear Rol"); ?></h3>
                                                    </div>
                                                    <div class="modal-body">
                                                        <h3><?php echo $dto->mostraNomEmpresa($idempresa); ?></h3>
                                                        <br>
                                                        <form name="nourol" onsubmit="event.preventDefault();">
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        <td><label><?php echo $dto->__($lng, "Empleat"); ?>: </label></td>
                                                                        <td><input id="chkesemp" name="empleat" type="checkbox" style="height: 25px; width: 25px" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><label><?php echo $dto->__($lng, "Administrador"); ?>: </label></td>
                                                                        <td><input id="chkesadm" name="admin" type="checkbox" style="height: 25px; width: 25px" /></td>
                                                                    </tr>
                                                                    <?php if ($master) {
                                ...
                                <div class="col-lg-4">
                                    <br><br>
                                    <h3 class=""><?php echo $dto->__($lng, "Opcions") . " " . $dto->__($lng, "Empresa"); ?></h3><br><br>
                                    <div class="row">
                                        <div class="col-lg-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <label class=""> Usuario responsable RRHH </label>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="form-group">
                                                <?php $chkpers = 0;
                                                    $responseEmailIndex = $dto->getDb()->executarConsulta('select emailIndex from empresa where idempresa=' . $idempresa);
                                                    $email_select = $responseEmailIndex[0]['emailIndex'];

                                                    $stmt = $conn->prepare("select idempleat, email, nom, cognom1, cognom2 from empleat where email = ?");
                                                    $stmt->bind_param("s", $email_select);
                                                    $stmt->execute();
                                                    $stmt->bind_result($idempleat, $email_result, $nom_result, $cognom1_result, $cognom2_result);
                                                    ...
                                                    while ($stmt->fetch()) {
                                                        $empleat_email = [
                                                            ...
                                                            "email" => $email_result,
                                                            "nom"=> $nom_result,
                                                            "cognom1"=> $cognom1_result,
                                                            "cognom2"=> $cognom2_result
                                                        ];
                                                    }
                                                    $stmt->close();
                                                    $empleatsByEmail = $dto->seleccionaPersonaParaEmail();
                                                ?>
                                                
                                                <select name="mail_index" onchange="capturarEmail('<?php echo $idempresa; ?>');" style="width: 150px; height: 35px;">
                                                    <?php
                                                    if($empleat_email) echo '<option value="' . $empleat_email["email"] . '">' . $empleat_email["cognom1"] . '
                                                        ' . $empleat_email["cognom2"] . '  ' .  $empleat_email["nom"] . '</option>';
                                                    else echo '<option value="">' . $dto->__($lng, "selecciona persona") . '</option>';
                                                    foreach ($empleatsByEmail as $emp) if($empleat_email['idempleat'] != $emp['idempleat']) echo '<option value="' . $emp["email"] . '">' . $emp["cognom1"] . '
                                                        ' . $emp["cognom2"] . '  ' .  $emp["nom"] . '</option>';
                                                    ?>
                                                </select>
								...
								<br>
                                    ...
                                    <div class="row mt-5 p-5">
                                        <div class="col-lg-7">
                                            <label class="">Email al RRHH</label>
                                        </div>
                                        <div class="col-lg-3">
                                            <?php
                                            $responseCheckEmailIndex = $dto->getDb()->executarConsulta('select checkEmailIndex from empresa where idempresa=' . $idempresa);
                                            $chk1EmailIndex = null;
                                            if ($responseCheckEmailIndex[0]["checkEmailIndex"] == 1) {
                                                $chk1EmailIndex = "checked";
                                            }
                                            ?>
                                            <input type="checkbox" id="chk1EmailIndex" <?php echo $chk1EmailIndex; ?> style="width: 25px; height: 25px;" onchange="updateEmailIndex(this);">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <label class="">Primer Marcaje del día siempre entrada</label>
                                        </div>
                                        <div class="col-lg-3">
                                            <?php
                                            $chk1marcatge = null;
                                            ...
                                            ?>
                                            <input type='checkbox' id="chk1marcatge" <?php echo $chk1marcatge; ?> style="width: 25px; height: 25px;" onchange='updatePrimerMarcage(this);'>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-5 p-5">
                                        <div class="col-lg-7">
                                            <label class="">Marcajes especiales del index</label>
                                        </div>
                                        <div class="col-lg-3">
                                            <?php
                                    ...
                                    foreach ($rsinfemp as $ie) {
                                        if ($ie["idtipusinforme"] == 1) {
                                            if ($ie["checked"] == 1) {
                                                $chkdinf1 = "checked";
                                            }
                                        }
                                        if ($ie["idtipusinforme"] == 2) {
                                            if ($ie["checked"] == 1) {
                                                $chkdinf2 = "checked";
                                            }
                                        }
                                    ...
                                    ?>
                                    <br><br>
                                    <h3 class=""><?php echo $dto->__($lng, "Informes") . " " . $dto->__($lng, "Disponibles"); ?></h3><br><br>
                                    <div class="row">
                                        <div class="col-lg-7">
    ...
    <div class="modal fade" id="modEliminarFestius" role="dialog">
            ...
            <div class="modal-dialog">
                <div class="modal-content ">
                    <div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h3><?php echo $dto->__($lng, "Alta de Subempresa Nova"); ?></h3>
                    </div>
                    <div class="modal-body">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style='background-color: lavender'>
                        <div class="row">
                            <div class="col-lg-2"><img src="./img/g3sminilogo.jpg" style="width: 100%; max-height: 80px" /></div>
                            <div class="col-lg-8">
    ...
    <div class="modal fade" id="modLoad" role="dialog">
        <center>
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body">
                        <h1><?php echo $dto->__($lng, "Carregant"); ?>...<img src="./Pantalles/img/Loading_icon.gif" style="height: 200px; width: 280px"></h1>
                    </div>
                </div>
            </div>
        </center>
    ...
    <script>
        ...
        function changeHoraElectVal(checkbox, idtipusexcep) {
            ...
            $.ajax({
                url: "updateHoraElectivaPeriodoEspecial.php",
                type: "POST",
                data: {
                    valor: valor,
                    idtipusexcep: idtipusexcep
                },
                success: function(response) {
                    console.log(response);
                },
        ...
        function updatePrimerMarcage(checkbox) {
            var valor = checkbox.checked ? 1 : 0; // Obtener el valor 1 si está marcado, de lo contrario, obtener 0
            var idempresa = 7; // Reemplaza con el valor correcto de idempresa

            // Realizar la solicitud AJAX utilizando jQuery
            $.ajax({
                url: "updatePrimerMarcage.php",
                type: "POST",
                data: {
                    idempresa: idempresa,
                    valor: valor
        ...
        function changeRequerePeriodSpecial(checkbox, idtipusexcep) {
            const valor = checkbox.checked ? 1 : 0;
            console.log(valor);
            ...
            $.ajax({
                url: "updateDocumentoRequeridoPeriodoEspecial.php",
                type: "POST",
                data: {
                    valor: valor,
                    idtipusexcep: idtipusexcep
        ...
        function capturarEmail(idempresa) {
            var selectElement = document.getElementsByName("mail_index")[0];
            var correo = selectElement.options[selectElement.selectedIndex].value;

            $.ajax({
                url: "updateMailCompany.php",
                type: "POST",
                data: {
                    correo,
                    idempresa
		...
		function updateEmailIndex(checkbox) {
            var valor = checkbox.checked ? 1 : 0; // Obtener el valor 1 si está marcado, de lo contrario, obtener 0
            var idempresa = 7; // Reemplaza con el valor correcto de idempresa

            // Realizar la solicitud AJAX utilizando jQuery
            $.ajax({
                url: "updateEmailIndex.php",
                type: "POST",
                data: {
                    idempresa: idempresa,
                    valor: valor
		...
		function crearDepartamento( idempresa) {
            var nomdpt = document.getElementById('nomdpt').value;
            var ambit = document.getElementById('ambit').value;
            console.log(idempresa,nomdpt,ambit);
    ...
    xmlhttp.open("GET", "Serveis.php?action=crearDepartament&nomdpt=" + nomdpt + "&idempresa=" + idempresa +  "&ambit=" + ambit, true);
    xmlhttp.send();
}
