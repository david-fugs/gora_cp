                            ...
                            while ($fechaInicio <= $fechaFin) {
                                ...
                                foreach ($idtreballador['rows'] as $row) {
                                    ...
                                    if ($diaActual == $fechaRegistro) {
                                        ...
                                        $data_time = [];
                                        $data_time= calcularTotalHoras($entries, $exits,$id,$fechaRegistro);
                                ...
                                echo "<tr>";
								 ...
								 $horasOrdinaries= ($horasRegistradas ? $data_time['totalFormato'] : "0:00");
                                $horasVoluntaries = ($horasDiferencia ? $diferenciaHoras['totalFormatoDiferencia'] : "0:00");
                                if ($entrada1 == "" && $salida1 == "" && $entrada2 == "" && $salida2 == "" && $entrada3 == "" && $salida3 == "" ){
                                    $horasOrdinaries="";
                                    $horesteoriques = "";
                                    $horasVoluntaries = "";
                                }
                                echo "<td>" . $horasOrdinaries . "</td>";
                                echo "<td>" . $horesteoriques . "</td>";
                                echo "<td>" .  $horasVoluntaries . "</td>";
