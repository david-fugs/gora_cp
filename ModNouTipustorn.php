            ...
            <table class="table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    echo '<tr>
                        ...
                        <td><input type="text" name="htreb" min="0" max="24" step="0.1" size="3" placeholder="00:00"></td>
                        <td><input type="text" name="hnoct" min="0" max="24" step="0.1" size="2" placeholder="00:00"></td>
                        <td><input type="text" name="hdesc" min="0" max="24" step="0.1" size="2" placeholder="00:00"></td>
